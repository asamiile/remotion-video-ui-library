...
const families = [
  ...
  { type: "pattern", file: "Text/DottedLineMarkerText/DottedLineMarkerText-v1/dotted-line-marker-text.composition", export: "dottedLineMarkerV1Patterns", localName: "dottedLineMarkerTextV1Patterns" },
  { type: "pattern", file: "Text/TypewriterText/TypewriterText-v1/typewriter-text.composition", export: "typewriterTextV1Patterns" },
  ...
  { type: "pattern", file: "Text/CodeStream/CodeStream-v1/code-stream.composition", export: "codeStreamV1Patterns" },
  { type: "pattern", file: "Text/StackedRevealText/StackedRevealText-v1/stacked-reveal-text.composition", export: "stackedRevealTextV1Patterns" },
  { type: "pattern", file: "Text/TornNoteCaption/TornNoteCaption-v1/torn-note-caption.composition", export: "tornNoteCaptionV1Patterns" },
