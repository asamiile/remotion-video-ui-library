...
import { dottedLineMarkerV1Patterns } from "../Text/DottedLineMarkerText/DottedLineMarkerText-v1/dotted-line-marker-text.composition";
import { typewriterTextV1Patterns } from "../Text/TypewriterText/TypewriterText-v1/typewriter-text.composition";
...
import { codeStreamV1Patterns } from "../Text/CodeStream/CodeStream-v1/code-stream.composition";
import { stackedRevealTextV1Patterns } from "../Text/StackedRevealText/StackedRevealText-v1/stacked-reveal-text.composition";
import { tornNoteCaptionV1Patterns } from "../Text/TornNoteCaption/TornNoteCaption-v1/torn-note-caption.composition";
