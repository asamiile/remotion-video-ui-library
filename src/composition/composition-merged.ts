...
import { ledTextV1Patterns } from "../Text/LedText/LedText-v1/led-text.schema";
import { neonTextV1Patterns } from "../Text/NeonText/NeonText-v1/neon-text.schema";
import { slideInCaptionV1Patterns } from "../Text/SlideInCaption/SlideInCaption-v1/slide-in-caption.schema";
import { glitchTextV1Patterns } from "../Text/GlitchText/GlitchText-v1/glitch-text.schema";
import { glitchTextV1RandomPatterns } from "../Text/GlitchText/GlitchText-v1/glitch-text-random.schema";
import { wireTextV1Patterns } from "../Text/WireText/WireText-v1/wire-text.schema";
import { neonTextRainbowV1Patterns } from "../Text/NeonTextRainbow/NeonTextRainbow-v1/neon-text-rainbow.schema";
import { lightSweepTextV1Patterns } from "../Text/LightSweepText/LightSweepText-v1/light-sweep-text.schema";
import { randomLinesV1Patterns } from "../Background/RandomLines/RandomLinesBackground-v1/random-lines.schema";
import { dottedLineMarkerV1Patterns } from "../Text/DottedLineMarkerText/DottedLineMarkerText-v1/dotted-line-marker-text.schema";
import { typewriterTextV1Patterns } from "../Text/TypewriterText/TypewriterText-v1/typewriter-text.schema";
import { shakeTextV1Patterns } from "../Text/ShakeText/ShakeText-v1/shake-text.schema";
import { confettiPopTextV1Patterns } from "../Text/ConfettiPopText/ConfettiPopText-v1/confetti-pop-text.schema";
import { loadingIconV1Patterns } from "../Loading/LoadingIcon-v1/loading-icon.schema";
import { codeStreamV1Patterns } from "../Text/CodeStream/CodeStream-v1/code-stream.schema";
import { stackedRevealTextV1Patterns } from "../Text/StackedRevealText/StackedRevealText-v1/stacked-reveal-text.schema";
import { tornNoteCaptionV1Patterns } from "../Text/TornNoteCaption/TornNoteCaption-v1/torn-note-caption.schema";
import { distressedTitleCardV1Patterns } from "../Text/DistressedTitleCard/DistressedTitleCard-v1/distressed-title-card.schema";
import { sprayPaintTextV1Patterns } from "../Text/SprayPaintText/SprayPaintText-v1/spray-paint-text.schema";
import { battleCalloutBannerV1Patterns } from "../UI/BattleCalloutBanner/BattleCalloutBanner-v1/battle-callout-banner.schema";
import { asymmetricStatusPanelV1Patterns } from "../UI/AsymmetricStatusPanel/AsymmetricStatusPanel-v1/asymmetric-status-panel.schema";
