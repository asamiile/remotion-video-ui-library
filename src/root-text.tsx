...
import { codeStreamSchemaV1 } from "./Text/CodeStream-v1/code-stream.schema";
import {
...
import { LedTextTemplateV1 } from "./Text/LedText-v1/LedTextTemplate";
import { ledTextSchemaV1 } from "./Text/LedText-v1/led-text.schema";
import { NeonTextTemplateV1 } from "./Text/NeonText-v1/NeonTextTemplate";
import { neonTextSchemaV1 } from "./Text/NeonText-v1/neon-text.schema";
import { SlideInCaptionTemplateV1 } from "./Text/SlideInCaption-v1/SlideInCaptionTemplate";
import { slideInCaptionSchemaV1 } from "./Text/SlideInCaption-v1/slide-in-caption.schema";
import { slideInCaptionV1DurationFrames } from "./Text/SlideInCaption-v1/slide-in-caption.schema";
...
import { WireTextTemplateV1 } from "./Text/WireText-v1/WireTextTemplate";
import { wireTextSchemaV1 } from "./Text/WireText-v1/wire-text.schema";
import { wireTextV1DurationFrames } from "./Text/WireText-v1/wire-text.schema";
import { NeonTextRainbowTemplateV1 } from "./Text/NeonTextRainbow-v1/NeonTextRainbowTemplate";
import { neonTextRainbowSchemaV1 } from "./Text/NeonTextRainbow-v1/neon-text-rainbow.schema";
import { neonTextRainbowV1DurationFrames } from "./Text/NeonTextRainbow-v1/neon-text-rainbow.schema";
import { LightSweepTextTemplateV1 } from "./Text/LightSweepText-v1/LightSweepTextTemplate";
import { lightSweepTextSchemaV1 } from "./Text/LightSweepText-v1/light-sweep-text.schema";
import { lightSweepTextV1DurationFrames } from "./Text/LightSweepText-v1/light-sweep-text.schema";
import { DottedLineMarkerTextV1 } from "./Text/DottedLineMarkerText-v1/DottedLineMarkerText";
import { dottedLineMarkerTextSchemaV1, dottedLineMarkerTextV1DurationFrames } from "./Text/DottedLineMarkerText-v1/dotted-line-marker-text.schema";
import { TypewriterTextTemplateV1 } from "./Text/TypewriterText-v1/TypewriterTextTemplate";
import { typewriterTextSchemaV1, typewriterTextV1DurationFrames } from "./Text/TypewriterText-v1/typewriter-text.schema";
import { ShakeTextTemplateV1 } from "./Text/ShakeText-v1/ShakeTextTemplate";
import { shakeTextSchemaV1 } from "./Text/ShakeText-v1/shake-text.schema";
import { shakeTextV1DurationFrames } from "./Text/ShakeText-v1/shake-text.schema";
import { ConfettiPopTextTemplateV1 } from "./Text/ConfettiPopText-v1/ConfettiPopTextTemplate";
import { confettiPopTextSchemaV1 } from "./Text/ConfettiPopText-v1/confetti-pop-text.schema";
import { confettiPopTextV1DurationFrames } from "./Text/ConfettiPopText-v1/confetti-pop-text.schema";
...
import { StackedRevealTextTemplateV1 } from "./Text/StackedRevealText-v1/StackedRevealTextTemplate";
import { stackedRevealTextSchemaV1 } from "./Text/StackedRevealText-v1/stacked-reveal-text.schema";
import { stackedRevealTextV1DurationFrames } from "./Text/StackedRevealText-v1/stacked-reveal-text.schema";
import { TornNoteCaptionTemplateV1 } from "./Text/TornNoteCaption-v1/TornNoteCaptionTemplate";
import { tornNoteCaptionSchemaV1 } from "./Text/TornNoteCaption-v1/torn-note-caption.schema";
import { tornNoteCaptionV1DurationFrames } from "./Text/TornNoteCaption-v1/torn-note-caption.schema";
import { DistressedTitleCardTemplateV1 } from "./Text/DistressedTitleCard-v1/DistressedTitleCardTemplate";
import { distressedTitleCardSchemaV1 } from "./Text/DistressedTitleCard-v1/distressed-title-card.schema";
import { distressedTitleCardV1DurationFrames } from "./Text/DistressedTitleCard-v1/distressed-title-card.schema";
import { SprayPaintTextTemplateV1 } from "./Text/SprayPaintText-v1/SprayPaintTextTemplate";
import { sprayPaintTextSchemaV1 } from "./Text/SprayPaintText-v1/spray-paint-text.schema";
import { sprayPaintTextV1DurationFrames } from "./Text/SprayPaintText-v1/spray-paint-text.schema";
import {
