...
import { RadialGlowSpinnerSchemaType } from "./radial-glow-spinner.schema";

export const RadialGlowSpinnerTemplate: React.FC<RadialGlowSpinnerSchemaType> = ({
  size,
  barCount,
  color,
  minOpacity,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    opacity: barOpacity,
                    filter: `drop-shadow(0 0 ${barGlow}px ${color})`,
